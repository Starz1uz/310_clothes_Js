...
function reload(arr, place) {
    ...
    for (let item of arr) {
        ...
        let hoho = document.querySelector('center h1 span')
        save_button.onclick = () => {
            cart_items.push(item)
            let delclick = hoho.innerHTML = cart_items.length
            save_button.style.background = 'blue'
            save_button.style.color = 'white'
            save_button.innerHTML = 'Добавленно'
